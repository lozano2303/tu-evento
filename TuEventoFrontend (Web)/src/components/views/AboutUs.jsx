  ...
  const teamMembers = [
    {
      id: 1,
      name: "Juan Delgado",
      email: "juan.delgado@tuevento.com",
      phone: "+57 300 123 4567",
      initials: "JD",
      role: "CEO & Fundador",
      description: "Líder visionario con más de 10 años de experiencia en la industria de eventos.",
      gradient: "from-purple-500 to-pink-500"
    },
    {
      id: 2,
      name: "María Rodríguez",
      email: "maria.rodriguez@tuevento.com", 
      phone: "+57 301 234 5678",
      initials: "MR",
      role: "Directora de Tecnología",
      description: "Experta en desarrollo de software y arquitectura de sistemas escalables.",
      gradient: "from-blue-500 to-cyan-500"
    },
    {
      id: 3,
      name: "Carlos García",
      email: "carlos.garcia@tuevento.com",
      phone: "+57 302 345 6789",
      initials: "CG",
      role: "Director de Diseño",
      description: "Especialista en UX/UI con enfoque en experiencias de usuario innovadoras.",
      gradient: "from-green-500 to-emerald-500"
    },
    {
      id: 4,
      name: "Ana López",
      email: "ana.lopez@tuevento.com",
      phone: "+57 303 456 7890",
      initials: "AL",
      role: "Gerente de Marketing",
      description: "Estratega de marketing digital con pasión por conectar marcas con audiencias.",
      gradient: "from-yellow-500 to-orange-500"
    },
    {
      id: 5,
      name: "Diego Pérez",
      email: "diego.perez@tuevento.com",
      phone: "+57 304 567 8901",
      initials: "DP",
      role: "Especialista en Eventos",
      description: "Coordinador de eventos con experiencia en gestión de proyectos complejos.",
